...
<a href="#" data-rel="back" data-role="button" data-theme="a" data-icon="delete" data-iconpos="notext" class="ui-btn-right">Close</a>
 ...
 -->
<?php if(isset($all_content) && is_array($all_content) && count($all_content)) {
...
<div class="alist" style="margin-bottom:2px; ">
  <div class="thumbnail-list">
    <ul  data-inset="true" data-role="listview" data-filter-theme="f">
     ...
     } else if (isset($all_content) && is_array($all_content) && count($all_content)) {
      foreach($all_content as $key => $val) { ?>   
